...
namespace Terec_Ioan_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Terec_Ioan_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Terec_Ioan_Lab8Context context,
